...
public class FirebaseStorageService {
    ...
    final String BucketName = "tiendatechshop-b7fb4.firebasestorage.app";

    //Esta es la ruta básica de este proyecto Techshop
    final String rutaSuperiorStorage = "myVlog";

    //Ubicación donde se encuentra el archivo de configuración Json
    final String rutaJsonFile = "firebase";

    //El nombre del archivo Json
    final String archivoJsonFile = "tiendatechshop-b7fb4-firebase-adminsdk-fbsvc-2154e38e87" + ".json";
    ...
    public String uploadFile(File file, String carpeta, String fileName) throws IOException {
    ...
    public File convertToFile(MultipartFile archivoLocalCliente) throws IOException {
